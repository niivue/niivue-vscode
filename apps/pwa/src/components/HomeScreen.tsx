...
export const HomeScreen = () => (
  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
    <div
      className="max-w-2xl w-full h-full overflow-y-auto p-4 sm:p-6 pointer-events-auto focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
      tabIndex={0}
      role="main"
      aria-label="NiiVue PWA Information"
    >
      <div className="max-w-xl mx-auto">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-200 mb-3">
          Drop Files to load images
        </h2>
        <p className="w-full sm:w-96 mb-6 text-m font-normal text-gray-300">
          Drag and drop files to an empty space on this window. Many medical image and mesh formats
          are supported.
        </p>

        <h2 className="text-2xl sm:text-3xl font-bold text-gray-200 mb-3">Install as local App</h2>
        <p className="w-full sm:w-96 mb-6 text-m font-normal text-gray-300">
          <img
            className="float-right ml-4 mb-2 w-32 sm:w-40 h-auto"
            src={imageUrl}
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-200 mb-3">Update App</h2>
        <p className="w-full sm:w-96 mb-6 text-m font-normal text-gray-300">
          ...
          <kbd className="bg-gray-600 px-2 py-1 rounded">Ctrl+Shift+R</kbd> to force refresh and
          clear the cache.
        </p>

        <h2 className="text-2xl sm:text-3xl font-bold text-gray-200 mb-3">Bookmarklet</h2>
        <p className="w-full sm:w-96 mb-6 text-m font-normal text-gray-300">
          Drag this link ⇨
          <a
            className="touch-manipulation inline-block mx-1"
            href="javascript: (() => {
          ...
          <a
            className="touch-manipulation inline-block mx-1"
            href="https://niivue.github.io/niivue-demo-images/mni152.nii.gz"
          >
            <b> MNI </b>
          </a>
        </p>

        <h2 className="text-2xl sm:text-3xl font-bold text-gray-200 mb-3">Data Privacy</h2>
        <p className="w-full sm:w-96 mb-6 text-m font-normal text-gray-300">
        ...
        <p className="w-full sm:w-96 mb-6 text-m font-normal text-gray-300">
          ...
          <a className="touch-manipulation" href="https://github.com/niivue/niivue/">
            <b> NiiVue</b>
          </a>{' '}
          and was initially developed at The University of Queensland by the Computational Imaging
          and
          <a className="touch-manipulation" href="https://www.neurodesk.org/">
            <b> NeuroDesk</b>
          </a>{' '}
          group.
        </p>
        <footer className="text-xs mb-4">
          <a
            ...
            className="text-gray-500 hover:underline touch-manipulation"
          >
