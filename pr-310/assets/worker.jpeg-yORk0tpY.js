(function() {
	var e, r = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, o = Object.getOwnPropertyNames, a = Object.getPrototypeOf, s = Object.prototype.hasOwnProperty, i = (e, r) => () => (r || (e((r = { exports: {} }).exports, r), e = null), r.exports), l = (e, i, l) => (l = null != e ? r(a(e)) : {}, ((e, r, a, i) => {
		...
		if (d) {
			var E = c("fs"), _ = c("path");
			y = i ? _.dirname(y) + "/" : c("url").fileURLToPath(new URL("/niivue-vscode/pr-310/assets/index-DiwRhbxb.js", "" + self.location.href)), f = (e, r) => (e = ee(e) ? new URL(e) : _.normalize(e), E.readFileSync(e, r ? void 0 : "utf8")), m = (e) => {
				var r = f(e, !0);
		...
		o.locateFile ? Z(V = "dcm2niix.jpeg.wasm") || (K = V, V = o.locateFile ? o.locateFile(K, y) : y + K) : V = new URL("/niivue-vscode/pr-310/assets/dcm2niix.jpeg-CQkhdqTF.wasm", "" + self.location.href).href;
		var oe = (e) => {
...
//# sourceMappingURL=worker.jpeg-yORk0tpY.js.map